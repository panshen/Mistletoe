 ...
 * @since 2013-8-15
 */
public class PullToRefreshGridViewWithHeaderAndFooter extends PullToRefreshBase<GridViewWithHeaderAndFooter> implements OnScrollListener {
     ...
     */
    public PullToRefreshGridViewWithHeaderAndFooter(Context context, AttributeSet attrs, int defStyle) {
