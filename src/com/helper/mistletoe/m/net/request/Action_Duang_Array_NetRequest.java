...
public class Action_Duang_Array_NetRequest extends Template_NetRequest {
	public Action_Duang_Array_NetRequest(Context context) {
		super(context, NetRequest_Bean.REQUEST_TYPE_POST, MainConst.NET_ACTION_DUANG_ARRAY);
	}

	public Boolean doActionDuang(ArrayList<Integer> Ids) throws Exception {
		/**
		...
		try {
			// 请求参数
			// 获取data
			String data_action_duang = MyJsonWriter.getJsonDataForActionDuang(Ids);
			// 连接
